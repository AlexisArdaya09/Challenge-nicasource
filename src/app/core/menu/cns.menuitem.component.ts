...
@Component({
  selector: '[cns-menuitem]',
  templateUrl: './cns.menuitem.component.pug',
  styleUrls: ['./cns.menuitem.component.scss'],
  host: {
...
export class CnsMenuitemComponent implements OnInit, OnDestroy {
  @Input() item: any;
  ...
  constructor(
    public app: MainLayaoutComponent,
