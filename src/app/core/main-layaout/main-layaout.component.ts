...
@Component({
    selector: 'cns-main-layaout',
    templateUrl: './main-layaout.component.pug',
...
export class MainLayaoutComponent implements AfterViewInit, OnDestroy, OnInit {
